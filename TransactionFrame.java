            ...
            try {
               ...
               //ADD PRODUCT BUTTON
                ...
                submitTransactionBtn.addActionListener(e2 -> {
                    try {
                        Client client = ClientService.authenticateClient(ClientFrame.getClientsList(), input.getText().trim());
                        if (client == null) {
                    ...
                    // }
                       ...
                       // System.out.println("Selected: " + selected);  
                        ...
                        productIds, quantities, storeId, client, ProductFrame.productService, StockService.stockService, selected,answer);
